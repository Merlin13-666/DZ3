...
int main(int argc, char* argv[])
{
    ...
    cout<<"Introduce an algorithm without spaces. (/ -division, * - multiplication) Real numbers should be written through a dot. Pi - 'pi', Napier's number - 'e'. Enter your expression: \n";
    switch(argc)
    {
        case 1:
            input=&cin;
